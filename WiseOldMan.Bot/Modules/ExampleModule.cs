...
public class ExampleModule : InteractionModuleBase<SocketInteractionContext>
{
    ...
    public async Task Echo(
        string echo,
        [Summary(description: "mention the user")] bool mention = false
    ...
    public async Task GetBitrateAsync(
        [ChannelTypes(ChannelType.Voice, ChannelType.Stage)] IChannel channel
    ) =>
        await RespondAsync(
            text: $"This voice channel has a bitrate of {(channel as IVoiceChannel).Bitrate}"
        );
